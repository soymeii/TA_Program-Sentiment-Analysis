...
df = pd.read_excel(r"C:\xampp\htdocs\TA\Program\result\crawling_from_shopee.xlsx")
...
output_path = r"C:\xampp\htdocs\TA\Program\result\preprocessed_from_shopee.xlsx"
